 ...
 * @param onTextLayout A callback that is invoked when the text layout is calculated. See [Text]
...
fun SirioTextCommonPreview() {
    SirioTheme {
        SirioTextCommon(text = "Testo", typography = SirioTheme.foundationTypography.labelMdHeavy)
    }
}
